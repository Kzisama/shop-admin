  ...
  <div class="my-header">
    ...
    <div class="ml-auto mr-6 flex items-center">
      ...
      <el-dropdown class="dropdown">
        ...
        <template #dropdown>
          <el-dropdown-menu>
            <el-dropdown-item @click="showDrawer = true">修改密码</el-dropdown-item>
    ...
    <el-drawer v-model="showDrawer" title="修改密码" size="45%" :close-on-click-modal="false">
      <el-form ref="formRef" :rules="rules" :model="form">
        ...
        <el-form-item>
          <el-button color="#626aef" @click="onSubmit(formRef)">
            提 交
          </el-button>
        </el-form-item>
      </el-form>
...
const showDrawer = ref<boolean>(false); // 修改密码drawer的展示状态
...
const validatePass = (rule: any, value: any, callback: any) => { // 自定义验证--新密码
  if (!value) {
...
const validatePass2 = (rule: any, value: any, callback: any) => { // 自定义验证-确认密码
  if (value === "") {
...
const rules: FormRules = { // 验证规则
  oldpassword: [{ required: true, message: "原密码不能为空", trigger: "blur" }],
  password: [{ validator: validatePass, trigger: "blur" }],
  repassword: [{ validator: validatePass2, trigger: "blur" }]
};
const onSubmit = (formEl: FormInstance | undefined) => { // 更新密码
  if (!formEl) return;
